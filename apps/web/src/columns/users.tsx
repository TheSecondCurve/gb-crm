...
export function userColumns(role: SystemRole | null): GridColumn<UserDto>[] {
  ...
  return [
    ...
    { key: "realName", label: "真实姓名", editor: "text", editable: canEdit, defaultVisible: false },
    { key: "phone", label: "电话", editor: "text", editable: canEdit, defaultVisible: false },
    { key: "wechat", label: "个人微信", editor: "text", editable: canEdit, defaultVisible: false },
    { key: "duties", label: "职责描述", editor: "textarea", editable: canEdit, defaultVisible: false },
    { key: "notes", label: "其他备注", editor: "textarea", editable: canEdit, defaultVisible: false },
