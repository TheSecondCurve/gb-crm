...
// K31：POST 用 customers.create（assistant 403）；PATCH body 含 ownerId 键时追加
// customers.updateOwners 门槛（assistant 403，键存在即拦，null 也算），
...
const OWNER_KEYS = ["ownerId"] as const;
